...
def build_portable() -> bool:
    ...
    exclude_modules = [
        ...
        "tkinter", "unittest", "pytest", "doctest",
        "IPython", "jupyter", "notebook", "qtpy",
        ...
        "requests", "urllib3",  # 如果不需要网络请求
        "email", "http", "ftplib", "ssl",
        "xmlrpc", "html",
    ]
...
def main():
    parser = argparse.ArgumentParser(
        description="MechForge AI 优化版打包脚本"
    )
    parser.add_argument(
        "--mode",
